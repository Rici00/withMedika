...
const prices = [
  36.8,35.6,37.2,34,27.7,24.4,21.6,17.8,14,
]
...
export function Hero() {
  return (
    <div className="overflow-hidden bg-cyan-200 py-20 sm:py-32 lg:pb-32 xl:pb-36">
      <Container>
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            <h1 className="text-4xl font-medium tracking-tight text-gray-900">
              Yuk Maksimalkan Tumbuh Kembang Anak Kita
            </h1>
            <p className="mt-6 text-lg text-gray-600">
            Berikan gizi seimbang dan pola makan yang sehat untuk tumbuh kembang optimal. 
            Dengan langkah kecil hari ini, kita ciptakan masa depan lebih baik bagi buah hati kita!
            </p>
            <div className="mt-8 flex flex-wrap gap-x-6 gap-y-4">
              <Button
                href="https://www.youtube.com/watch?v=zqpinGFvivg"
                variant="solid"
              >
                <PlayIcon className="h-6 w-6 flex-none" />
                <span className="ml-2.5">Tonton Video Edukasi Stunting</span>
              </Button>
            </div>
          </div>
